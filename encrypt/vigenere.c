...
char shiftChar(char c, int shift, int direction)
{
  ...
  //  given a char c shift it either forwards (direction == 1) or backwards (directio$
...
void vigenereEncrypt(char str[], int shift)
{
  int shifts[] = { shift };
...
void vigenereDecrypt(char str[], int shift)
{
  int shifts[] = { shift };
